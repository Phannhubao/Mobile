...
class _AdminProductScreenState extends State<AdminProductScreen> {
  ...
  Widget _buildProductCard(Product product, double scale) {
    final imageUrl = AppConstants.resolveUrl(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, idx) {
                          ...
                          final netUrl = AppConstants.resolveUrl(imgPath);
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  netUrl,
                                  headers: AppConstants.imageHeaders(netUrl),
                                  fit: BoxFit.cover,
                    ...
                    Wrap(
                      spacing: 8 * scale,
                      runSpacing: 8 * scale,
                      children: widget.tags.map((tagModel) {
                        final tag = tagModel.tagName;
